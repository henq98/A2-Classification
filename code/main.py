...
#from fixed_param import data_loading, SVM_classification, RF_classification, FEATURE_NAMES
...
if __name__ == '__main__':
    ...
    #svm_model_selected, svm_acc_selected, svm_params_selected = SVM_classification(
    #    X,
    #    y,
    #    feature_indices=selected_indices,
    #    kernel="poly",
    ...
    #rf_model_selected, rf_acc_selected, rf_params_selected, rf_importances, rf_ranking = RF_classification(
    #    X,
    #    y,
    #    feature_indices=selected_indices,
    #    n_estimators=100,
